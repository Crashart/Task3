...
func request_EmployeeService_Read_0(ctx context.Context, marshaler runtime.Marshaler, client EmployeeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetOneEmployeeRequest
	var metadata runtime.ServerMetadata
...
func request_EmployeeService_Create_0(ctx context.Context, marshaler runtime.Marshaler, client EmployeeServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := marshaler.NewDecoder(newReader()).Decode(&protoReq.Emp); err != nil && err != io.EOF {
...
var (
	pattern_EmployeeService_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"unit", "id", "employees"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EmployeeService_Read_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"unit", "id", "employee", "id1"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EmployeeService_Create_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2}, []string{"unit", "id", "employee"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EmployeeService_Update_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"unit", "id", "employee", "id1"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_EmployeeService_Delete_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 1, 0, 4, 1, 5, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"unit", "id", "employee", "id1"}, "", runtime.AssumeColonVerbOpt(true)))
)
